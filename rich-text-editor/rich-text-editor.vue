...
<style>
  ...
  .rich-t-tool:active{ background:darken(#EEE, 7%) }
  .rich-t-tool.active{
    background:#888;
    color:#fff;
  }
  .rich-t-tool.color-tool.active{
  ...
  .rich-t-edit-area:focus{ border:1px solid darken(#2386fb,6%); }

  .rich-t-submit-btn{
    padding:10px 5px;
    background: #fff;
  }
  .rich-t-submit-btn.active{opacity: 0;}
